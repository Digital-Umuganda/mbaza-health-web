...
import { adminSidebarNavLinks } from '@/constants/navigation';
...
const AdminRoute = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-slate-600 border-b border-gray-300 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              <button
                ...
                type="button"
                onClick={onToggle}
                className="inline-flex items-center p-2 focus:text-slate-600 text-sm text-gray-100 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
              >
      ...
      <aside
        ...
        } sm:translate-x-0 fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-300 dark:bg-gray-800 dark:border-gray-700`}
        aria-label="Sidebar"
      >
      ...
      <div className="p-4 sm:ml-64 py-20 flex flex-col bg-gray-100 flex-grow">
